                      ...
                      double const time)
{
  ...
  coefficients = apply_fmwt(forward_trans,apply_fmwt(forward_trans, coefficients,dim.get_degree(),dim.get_level(),true,false),dim.get_degree(),dim.get_level(),false,true);
